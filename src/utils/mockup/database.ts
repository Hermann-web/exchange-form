...
const MOCK_SUBMISSION_DATA: SubmissionData = {
  ...
  choice1: { schoolName: 'centrale_supelec', thematicSequence: 'thematic Sequence 1' },
  choice2: { schoolName: 'centrale_lyon', thematicSequence: 'thematic Sequence 2' },
  ...
  choice1LearningAgreementUrl: 'https://mock-db.com/choice1-learning-agreement.pdf',
  residencePermitUrl: 'https://mock-db.com/residence-permit.pdf',
  choice2LearningAgreementUrl: 'https://mock-db.com/choice2-learning-agreement.pdf',
